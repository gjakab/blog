                            ...
                            return(
                                <div  key ={article._id}>
                                    <div className="article">
                                        <h2 className="articleTitle">{article.title}</h2> by <p className="articleAuthor">{article.user.name}</p>
                                    ...
                                    <ul>
                                        {
                                            article.comments.map((comment)=>{
                                                return (
                                                    <div key ={comment._id}>
                                                        <p className="commentBody"><p className="comment">{comment.text}</p> by {comment.user.name} </p>
                                                    </div>
                                                )
                                            })
                                        }
